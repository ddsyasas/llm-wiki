...
Last updated: 2026-05-24 (post-v1.0 sprint, latest: 10-item V1.x sprint — quick wins + all six medium items). Forward-looking work-needed view: [`docs/14-roadmap.md`](14-roadmap.md).
